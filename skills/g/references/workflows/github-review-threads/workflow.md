...
Load [../../states.md](../../states.md) before classifying feedback,
...
- `workflows.md`: feedback, reply, resolution, and direct-command flows.
- `../../states.md`: feedback, review, reconciliation, and resolution
  states.
- `script-summary.md`: shared `g reviews` contract.
- `../../options.md`: shared canonical G options and caller handoffs.
