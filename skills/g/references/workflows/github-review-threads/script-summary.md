...
```bash
<skill-root>/scripts/g reviews --help
<skill-root>/scripts/g --version
<skill-root>/scripts/g doctor
<skill-root>/scripts/g --json doctor
<skill-root>/scripts/g --json repo snapshot
<skill-root>/scripts/g --json reviews operation prepare --controller-envelope-file <absolute-controller-json> --input-file <absolute-input-json> --request-output <absolute-request-json>
<skill-root>/scripts/g --json reviews operation validate-request --request-file <absolute-request-json>
<skill-root>/scripts/g --json reviews operation execute --request-file <absolute-request-json> --result-output <absolute-result-json>
<skill-root>/scripts/g --json reviews operation reconcile --request-file <absolute-reconciliation-request-json> --result-output <absolute-result-json>
<skill-root>/scripts/g --json reviews operation validate-result --request-file <absolute-request-json> --result-file <absolute-result-json>
<skill-root>/scripts/g reviews address --repo <owner/repo> --pr <number>
<skill-root>/scripts/g --json reviews request --provider codex --repo <owner/repo> --pr <number> --head <full-40-sha> --request-key <request-key> --reservation-file <absolute-reservation-file>
<skill-root>/scripts/g --json reviews reply --repo <owner/repo> --pr <number> --head <full-40-sha> --comment-id <id> --request-key <request-key> --request-fingerprint <request-fingerprint> --body-file <absolute-message-file> --reservation-file <absolute-reservation-file>
<skill-root>/scripts/g --json reviews resolve --repo <owner/repo> --pr <number> --head <full-40-sha> --request-key <request-key> --request-fingerprint <request-fingerprint> --reply-receipt-file <absolute-receipt-file> --reservation-file <absolute-reservation-file>
<skill-root>/scripts/g reviews edit-comment --repo <owner/repo> --pr <number> --kind <conversation-or-review> --comment-id <id> --body-file <absolute-message-file>
<skill-root>/scripts/g reviews submit-review --repo <owner/repo> --pr <number> --event <approve-or-request-changes-or-comment> --body-file <absolute-message-file>
<skill-root>/scripts/g reviews comment --repo <owner/repo> --pr <number> --head <full-40-sha> --request-key <request-key> --request-fingerprint <request-fingerprint> --body-file <absolute-message-file> --reservation-file <absolute-reservation-file>
<skill-root>/scripts/g --json reviews ready-trigger --provider codex --repo <owner/repo> --pr <number> --head <full-40-sha> --ready-event-id <event-id> --ready-ref <event-url> --ready-at <utc-timestamp> --base-branch <branch> --body-fingerprint <sha256> --output-file <absolute-ready-receipt-file>
<skill-root>/scripts/g --json reviews check --provider codex --repo <owner/repo> --pr <number> --head <sha>
<skill-root>/scripts/g --json reviews wait --provider codex --repo <owner/repo> --pr <number> --head <full-40-sha> --request-receipt-file <absolute-receipt-file> --timeout <caller-owned-duration>
<skill-root>/scripts/g --json reviews ready-check --provider codex --repo <owner/repo> --pr <number> --head <full-40-sha> --ready-receipt-file <absolute-ready-receipt-file>
<skill-root>/scripts/g --json reviews ready-wait --provider codex --repo <owner/repo> --pr <number> --head <full-40-sha> --ready-receipt-file <absolute-ready-receipt-file> --timeout <caller-owned-duration>
<skill-root>/scripts/g --json reviews terminal-evidence --provider codex --repo <owner/repo> --pr <number> --head <full-40-sha> --request-receipt-file <absolute-receipt-file>
```

Use the `<skill-root>` resolved by the active G entrypoint. All provider text is mandatory file-backed input; inline provider
...
The shipped command is built from the skill CLI project and invoked only through `<skill-root>/scripts/g`.
