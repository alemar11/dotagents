...
from code_wiki.pilot.comparison import build_decision  # noqa: E402
...
"""
    ...
    def write_fixture(self, root: Path, mode: str, *, repair: bool = False, failure: str | None = None, delay_ms: int = 0) -> Path:
                ...
                "study-architecture": [
                    {
                        "events": [success],
                        "delay_ms": delay_ms,
                        "writes": {"artifacts/study-architecture.md": "architecture README.md:1-10\n"},
                    }
                ],
                "study-interfaces": [
                    {
                        "events": [success],
                        "delay_ms": delay_ms,
                        "writes": {"artifacts/study-interfaces.md": "interfaces pkg/main.py:1-4\n"},
                    }
                ],
                "study-operations": [
                    {
                        "events": [success],
                        "delay_ms": delay_ms,
                        "writes": {"artifacts/study-operations.md": "operations tests/test_main.py:1-4\n"},
                    }
                ],
                "synthesize": [
                    {
                        "events": [success],
                        "writes": {"artifacts/synthesis.md": "complete page-by-page synthesis\n"},
                    }
                ],
                "render": [
                    {
    ...
    def test_strict_node_contracts_bind_graph_order_and_reader_identity(self) -> None:
        ...
        self.assertEqual(candidate.nodes["synthesize"].dependencies, (
            "study-architecture",
            "study-interfaces",
            "study-operations",
        ))
    ...
    def test_jsonl_usage_aggregation_rejects_missing_duplicate_and_negative_usage(self) -> None:
        ...
        self.assertEqual(usage.total_model_tokens, 160)
        for payload in (
        ...
        generation.update(
            {
                ...
                "output_tokens": output,
                "reasoning_output_tokens": reasoning,
                "total_model_tokens": input_tokens + output + reasoning,
                "wall_time_ms": wall,
