...
class AtomicClaimHelperTests(unittest.TestCase):
    ...
    def write_terminal_ledger(
        ...
        helper = CACHE_TEST_RUNTIME.LedgerCacheV23Tests(methodName="runTest")
        ...
        registration = CACHE_TEST_RUNTIME.LedgerCacheV23Tests.registration_for(
            helper, claim
        )
            ...
            specs.append(
                {
                    ...
                    "task_assignment_fingerprint": (
                        hashlib.sha256(
            CACHE_TEST_RUNTIME.LedgerCacheV23Tests.task_assignment_objective.encode()
                        ).hexdigest()
                        if source_recorded
                        else "none"
                    ),
