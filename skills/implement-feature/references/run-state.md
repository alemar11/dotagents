...
atomic claim acquisition. `scripts/ledger-cache` v10 is the sole active-state
...
Active state accepts only ledger schema `7.0.0` created from registration
