...
Keep resumable ledger-schema `8.0.0` state as absolute direct-child `.json` files under
`~/.cache/dotagents/skills/implement-feature/ledgers/`. `ledger-cache` v11 is the
