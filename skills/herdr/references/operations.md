...
Use the installed CLI help for syntax. The caller-context examples below apply
inside a managed pane. Outside Herdr, use explicit discovered targets as
described in [the skill](../SKILL.md). For lifecycle meanings, read
[states](states.md).
