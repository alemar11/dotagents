...
from stars_lib import __version__
from stars_lib import star_api, star_lists, stars
...
class StarsContractTests(unittest.TestCase):
    ...
    def test_shipped_script_is_executable(self) -> None:
        ...
        self.assertEqual(artifact_version, __version__)
