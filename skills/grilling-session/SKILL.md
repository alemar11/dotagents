...
description: "Refine a topic or handoff one question at a time when explicitly requested or composed by another workflow."
---
...
Use `$grilling-session` to turn a topic, proposal, plan, or composed handoff into a
...
or result state. The registry below owns workflow transitions.
