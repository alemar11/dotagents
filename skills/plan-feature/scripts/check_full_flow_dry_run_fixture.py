...
class FullFlowDryRunFixtureTests(unittest.TestCase):
    ...
    def test_plan_feature_references_internal_phase_templates(self) -> None:
        ...
        self.assertIn("Domain knowledge: captured in <path or durable surface>", plan_feature)
        self.assertIn("Domain knowledge: deferred to <path or durable surface> because <reason>", plan_feature)
