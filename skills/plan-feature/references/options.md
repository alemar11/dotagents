...
- Keep the resolved GitHub target, paths, slugs, refs, branches, dependencies,
  source route, evidence, continuation data, `scope_repair_request`, and result
  state outside the option registry.
