...
from reviews_lib.common import GError
from reviews_lib.provider_text import api_request, read_text_file
...
class ProviderTextContractTests(unittest.TestCase):
    ...
    def test_api_transport_keeps_provider_text_out_of_argv(self) -> None:
        ...
        with mock.patch("reviews_lib.provider_text.subprocess.run", return_value=completed) as run:
