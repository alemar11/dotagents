...
Before closing, compare the issue body and latest known acceptance criteria
...
The follow-up should name the deferred behavior, the blocker or missing setup,
the proof already collected, and the remaining acceptance criteria. Do not
close a partially satisfied issue with only a chronological note or an implicit
