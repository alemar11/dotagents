...
Use `$github-issues` for authorized issue comments.

## Labels And Milestones

Read current labels before adding or removing labels:

Use `$github-issues` for authorized label changes.
...
Use `$github-issues` for authorized closing comments, follow-up issue creation,
