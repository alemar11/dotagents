...
and contextual fields only as evidence. When selection requires code,
root-cause, fix-quality, or acceptance evidence beyond the issue text, use
ordinary investigation; no dedicated skill. Read [states.md](states.md) before
returning or applying results.
