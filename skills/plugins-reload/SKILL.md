---
name: plugins-reload
description: Refresh this project's repo-local G and SE2 plugins in the Codex cache. Use after changing any plugin or when a new Codex task must load the current plugin files.
---
