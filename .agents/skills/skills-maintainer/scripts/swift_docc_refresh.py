...
USER_AGENT = "skills-maintainer-swift-docc-refresh"

REPO_ROOT = Path(__file__).resolve().parents[4]
SKILL_DIR = REPO_ROOT / "swift-docc"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Refresh the bundled Swift-DocC asset tree from skills-maintainer."
    )
