...
4. `review-fast-paths`: inspect `swift-api-design/references/*.md`,
...
- Do not add a runtime `swift-api-design/scripts/` directory.
- Do not add `.agents/skills/skills-maintainer` routing or commands to runtime
  `swift-api-design` docs.
- Treat `swift-api-design/assets/api-design-guidelines.md` as the bundled source
...
- Which `swift-api-design/references/*.md` files changed
