...
from within the `skills-maintainer` project skill.
...
- Refresh `swift-api-design/assets/api-design-guidelines.md` from
  `swiftlang/swift-org-website`.
- Refresh `swift-api-design/assets/manifest.json`.
- Review and update `swift-api-design/references/*.md` only when local routing
  or link integrity has materially drifted.
- Keep the procedure and maintainer tooling under
  `.agents/skills/skills-maintainer/`.
...
- Refresh script:
  `./.agents/skills/skills-maintainer/scripts/swift_api_design_refresh.py`
- Check script:
  `./.agents/skills/skills-maintainer/scripts/swift_api_design_check.py`
...
1. Check bundled asset freshness:
   - `python3 .agents/skills/skills-maintainer/scripts/swift_api_design_refresh.py --check-stale`
2. If stale, refresh the bundle:
   - `python3 .agents/skills/skills-maintainer/scripts/swift_api_design_refresh.py`
3. Validate the runtime package shape and link integrity:
   - `python3 .agents/skills/skills-maintainer/scripts/swift_api_design_check.py`
4. Review fast-path coverage manually:
   - `swift-api-design/references/README.md`
   - `swift-api-design/references/official-guidelines.md`
   - `swift-api-design/references/core-principles.md`
   - `swift-api-design/references/naming-and-signatures.md`
   - `swift-api-design/references/common-api-shaping-patterns.md`
   - `swift-api-design/references/review-checklist.md`
5. If curated-reference edits are needed, update those markdown files and rerun:
   - `python3 .agents/skills/skills-maintainer/scripts/swift_api_design_refresh.py`
   - `python3 .agents/skills/skills-maintainer/scripts/swift_api_design_check.py`
6. Ensure runtime docs stay clean:
   - no `swift-api-design/scripts/` directory
   - no maintainer-routing references in `swift-api-design/SKILL.md`
   - no maintainer commands in `swift-api-design/references/README.md`

## Validation

- `python3 -m py_compile .agents/skills/skills-maintainer/scripts/swift_api_design_refresh.py .agents/skills/skills-maintainer/scripts/swift_api_design_check.py`
- `python3 .agents/skills/skills-maintainer/scripts/swift_api_design_refresh.py --check-stale`
- `python3 .agents/skills/skills-maintainer/scripts/swift_api_design_check.py`
- `git diff --check`
