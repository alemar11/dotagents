...
`skills-maintainer` project skill.
...
## Scope
- Refresh `swift-docc/assets/DocCDocumentation.docc/` from `swiftlang/swift-docc`.
- Refresh `swift-docc/assets/manifest.json` and `swift-docc/references/source-map.md`.
- Review and update `swift-docc/references/*.md` only when local fast-path
  coverage or link integrity has materially drifted.
- Keep the procedure and maintainer tooling under `.agents/skills/skills-maintainer/`.
...
- Do not leave ad hoc temporary files in `swift-docc/`.
...
## Tooling
- Refresh script: `./.agents/skills/skills-maintainer/scripts/swift_docc_refresh.py`
- Check script: `./.agents/skills/skills-maintainer/scripts/swift_docc_check.py`
...
1. Check bundled asset freshness:
   - `python3 .agents/skills/skills-maintainer/scripts/swift_docc_refresh.py --check-stale`
...
6. Ensure runtime docs stay clean:
   - no `swift-docc/scripts/` directory
   - no maintainer-routing references in `swift-docc/SKILL.md`
   - no maintainer commands in `swift-docc/references/README.md`

## Validation
- `python3 -m py_compile .agents/skills/skills-maintainer/scripts/swift_docc_refresh.py .agents/skills/skills-maintainer/scripts/swift_docc_check.py`
- `python3 .agents/skills/skills-maintainer/scripts/swift_docc_refresh.py --check-stale`
- `python3 .agents/skills/skills-maintainer/scripts/swift_docc_check.py`
- `git diff --check`
