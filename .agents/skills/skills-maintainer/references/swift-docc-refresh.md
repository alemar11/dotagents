...
## Guardrails
- Do not reintroduce `swift-docc/scripts/` in the runtime skill.
- Do not add `.agents/skills/skills-maintainer` routing or commands to runtime `swift-docc` docs.
...
- Which `swift-docc/references/*.md` files changed
