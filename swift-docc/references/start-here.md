...
Use this page for the end-to-end DocC authoring flow: how to get a package or
framework documented, where to add prose, and which deeper guide to open next.
...
| Publishing and customization summary | You are done authoring and need to preview, host, or style the docs. | [Local](publishing-and-customization.md) |
