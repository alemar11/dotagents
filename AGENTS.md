...
- Both `plan-feature` phases should read `project-memory/config/issue-tracker.md` and related project memory before deciding where Feature Specs or issues belong.
