...
- Generated implementation issues must inherit the PRD delivery topology and record parallelization, integration mode, and closeout path so orchestrator workers can run parallel slices without inventing branch or PR strategy. (Codex learning)
