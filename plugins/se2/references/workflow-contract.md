...
This reference is the canonical owner of the hosted shape for the SE2 Idea
...
| --- | --- | --- | --- |
| `idea` | Idea hosted shape | Idea title, body, state, and native Issue Type | Feature Specs, Tasks, planning transitions |
