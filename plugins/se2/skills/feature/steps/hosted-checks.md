...
Read the current Feature set, Task state, relations, labels, issue types, and
collision evidence through the G-owned issue workflow. Reconcile the frozen
bundle against that state before mutation. Do not silently overwrite a foreign,
stale, duplicate, or contradictory hosted object.
