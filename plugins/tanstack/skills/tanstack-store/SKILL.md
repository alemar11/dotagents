---
name: tanstack-store
description: Review and implement TanStack Store usage for framework-agnostic reactive state, immutable updates, derived state, selectors, and framework adapters.
---

# TanStack Store

Use this skill when a task involves TanStack Store, framework-agnostic reactive state, immutable store updates, derived state, selectors, subscriptions, or React/Vue/Solid/Angular/Svelte store adapters.
