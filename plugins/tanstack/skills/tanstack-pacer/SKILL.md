---
name: tanstack-pacer
description: Review and implement TanStack Pacer usage for debouncing, throttling, rate limiting, queuing, batching, async control, and framework adapters.
---

# TanStack Pacer

Use this skill when a task involves TanStack Pacer, debouncing, throttling, rate limiting, queuing, batching, async work control, or replacing ad hoc timing utilities with TanStack-owned primitives.
