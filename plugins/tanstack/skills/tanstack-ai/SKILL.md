---
name: tanstack-ai
description: Review and implement TanStack AI usage for provider-agnostic streaming, tool calls, structured output, multimodal messages, workflows, and AG-UI integration.
---

# TanStack AI

Use this skill when a task involves TanStack AI packages, provider-agnostic AI SDK usage, streaming responses, tool calling, structured output, multimodal content, workflows, orchestrators, or AG-UI interoperability.
