---
name: tanstack-form
description: Review, implement, and migrate TanStack Form usage, including React Hook Form migrations, typed fields, arrays, validation, errors, reactivity, resets, and form composition.
---

# TanStack Form

Use this skill when a task involves `@tanstack/react-form`, form state, `useForm`, `useAppForm`, `form.Field`, `form.AppField`, form validators, field arrays, linked fields, custom errors, form composition, or migrating from React Hook Form.
