...
description: Review and implement TanStack Virtual usage for virtualized lists, grids, tables, dynamic measurement, scroll containers, overscan, and stable item identity.
---

# TanStack Virtual

Use this skill when a task involves TanStack Virtual, `useVirtualizer`, large list or grid rendering, virtualized tables, dynamic row measurement, custom scroll containers, overscan tuning, or scroll performance.
