---
name: tanstack-table
description: Review and implement TanStack Table usage for headless tables, column definitions, row models, sorting, filtering, pagination, selection, grouping, and virtualization integration.
---

# TanStack Table

Use this skill when a task involves `@tanstack/react-table`, headless table state, column definitions, row models, sorting, filtering, pagination, row selection, grouping, expansion, pinning, column visibility, or integrating tables with TanStack Virtual.
