...
- Enter the execution flow only when the user explicitly directs the skill to
  ...
  `$software-project:implement` execution request authorizes creating the disclosed
...
Use this skill only after explicit `$software-project:implement` invocation in the
