...
from gitstack import stars

SCRIPT = Path(__file__).resolve().parents[3] / "scripts" / "gitstack"
...
class StarsContractTests(unittest.TestCase):
    ...
    def test_manifest_package_and_shipped_artifact_versions_match(self) -> None:
        ...
        self.assertEqual(manifest["version"], "8.1.4")
    ...
    def test_version(self) -> None:
        ...
        self.assertEqual(stdout.getvalue().strip(), "8.1.4")
    ...
    def test_json_doctor_shape(self) -> None:
        ...
        self.assertEqual(payload["version"], "8.1.4")
