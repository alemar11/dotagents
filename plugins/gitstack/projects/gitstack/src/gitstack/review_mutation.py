...
RESERVATION_SCHEMA = "gitstack-review-provider-mutation:v1"
...
TRANSPORTS = {
    "review-request": {"tool": "gitstack", "domain": "reviews", "operation": "request", "method": "POST"},
    "review-warning": {"tool": "gitstack", "domain": "reviews", "operation": "comment", "method": "POST"},
    "review-reply": {"tool": "gitstack", "domain": "reviews", "operation": "reply", "method": "POST"},
    "review-resolution": {"tool": "gitstack", "domain": "reviews", "operation": "resolve", "method": "GRAPHQL"},
}
