...
remote; GitHub is the authoritative artifact store and `$g:github-issues`
...
Use `$g:github-issues` for issue reads, comments, relationships, types,
...
- `$se:implement` consumes only a durable hosted Feature Spec ref,
