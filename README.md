...
| `se2:implement` | Execute authoritative GitHub Features through a graph-first orchestrator, isolated workers, exact-HEAD review, Contract Repair, and verified standalone or stacked PR delivery. |
